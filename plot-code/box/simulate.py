...
tcga_id = open('../../bar-plot/{}-new-id.csv'.format(tt))
tcga_id_arr = tcga_id.readlines()
tcga_id.close()
new_tcga_id = strip(tcga_id_arr)
...
for ti in new_tcga_id:
	...
	for k in range(1000):
		for l in range(6):
			original_file = '../../TCGA-IC50/TCGA-{}/{}-qualified/{}.vcf.fa.pep/{}/qualified-{}.csv'.format(tt.upper(), tt, ti, rand_dict[k][l][4], rand_dict[k][l])
			output_dir = '../../box-plot/mid/{}/{}/{}'.format(tt, ti, k+1)
