...
input_path1 = '../../../box-plot/gender'
input_path2 = '../../../box-plot/gender/average-qualified-lines'
output_file = '../../../box-plot/gender/maybe-gender.csv'
f = open(output_file, 'a+')
f.write('number_per_patient,tumor_type,qualified,type\n')

for tt in tumor_type:
	for gen in gender:
		tumor_all = open('{}/{}-{}-patient.csv'.format(input_path1, tt, gen))
		tumor_new = open('{}/{}-{}.csv'.format(input_path2, tt, gen))
